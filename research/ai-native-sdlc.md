...
| **5** | **LLM Knowledge Cutoff** - Doesn't know about newer library semantics | LLM trained in Jan 2024. Doesn't know React 19 hooks, Next.js 15 App Router, Tailwind v4 utilities. Generates code using outdated v3 patterns. Code breaks. | **Context7 MCP** fetches latest library documentation and examples → LLM sees current semantics even if released after training cutoff. Always uses latest patterns. |
